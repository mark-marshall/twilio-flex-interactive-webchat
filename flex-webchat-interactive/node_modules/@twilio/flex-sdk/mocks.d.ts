 ...
 * @public
 */
export declare const getMock: <T extends "auth" | "getLogger" | "getTwilioIdpUrl" | "getPublicConfig" | "createClient">(name: T, config?: Parameters<Mocks[T]>[0] | undefined) => ReturnType<Mocks[T]>;
